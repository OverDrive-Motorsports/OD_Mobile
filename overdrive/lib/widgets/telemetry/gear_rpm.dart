          ...
          builder: (context, constraints) {
            ...
            return Padding(
              ...
              child: mode == TelemetryMode.small
                  ? _SmallGear(data: data, driverId: _driverId, rpmColor: rpmColor)
                  : _LargeGear(data: data, driverId: _driverId, rpmColor: rpmColor),
            );
          },
        ),
      ),
...
class _SmallGear extends StatelessWidget {
  const _SmallGear({required this.data, required this.driverId, required this.rpmColor});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
            ...
            child: TweenAnimationBuilder<double>(
              ...
              builder: (_, v, _) => Text(
                ...
                style: AppTextStyles.display(color: AppColors.textPrimary)
                    .copyWith(fontSize: 56, fontWeight: FontWeight.bold, letterSpacing: -3),
              ),
            ),
          ),
        ),
        Row(
          children: [
            Text('RPM', style: AppTextStyles.caption(color: AppColors.textMuted).copyWith(fontSize: 9)),
            const Spacer(),
            AnimatedDefaultTextStyle(
              duration: const Duration(milliseconds: 200),
              style: AppTextStyles.caption(color: rpmColor).copyWith(fontSize: 9, fontWeight: FontWeight.w600),
...
class _LargeGear extends StatelessWidget {
  const _LargeGear({required this.data, required this.driverId, required this.rpmColor});
  final TelemetrySnapshot data;
  final String driverId;
  final Color rpmColor;
          ...
          child: Center(
            child: TweenAnimationBuilder<double>(
              ...
              builder: (_, v, _) => Text(
                v.round().toString(),
                style: AppTextStyles.display(color: AppColors.textPrimary)
                    .copyWith(fontSize: 80, fontWeight: FontWeight.bold, letterSpacing: -4),
              ),
            ),
          ),
        ),
            ...
            child: SizedBox(
              ...
              child: Stack(children: [
                ...
                FractionallySizedBox(
                  ...
                  child: Container(color: AppColors.red.withValues(alpha: 0.15)),
                ),
                FractionallySizedBox(
                  widthFactor: f,
        ...
        if (isRedline) ...[
          ...
          Row(
            children: [
              ...
              Text(
                'REDLINE',
                style: AppTextStyles.label(color: AppColors.red).copyWith(fontSize: 9, letterSpacing: 0.8),
              ),
            ],
          ),
        ],
